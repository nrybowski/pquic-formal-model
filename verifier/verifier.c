...
inline void init__picoquic_packet_context_t(picoquic_packet_context_t *param1)
{
  ...
  param1->retransmit_newest = (picoquic_packet_t*) malloc(sizeof(picoquic_packet_t));
  assume(param1->retransmit_newest != NULL);
  init__picoquic_packet_t(param1->retransmit_newest);

  param1->retransmit_oldest = (picoquic_packet_t*) malloc(sizeof(picoquic_packet_t));
  assume(param1->retransmit_oldest != NULL);
  init__picoquic_packet_t(param1->retransmit_oldest);

  param1->retransmitted_newest = (picoquic_packet_t*) malloc(sizeof(picoquic_packet_t));
  assume(param1->retransmitted_newest != NULL);
  init__picoquic_packet_t(param1->retransmitted_newest);

  param1->retransmitted_oldest = (picoquic_packet_t*) malloc(sizeof(picoquic_packet_t));
  assume(param1->retransmitted_oldest != NULL);
  init__picoquic_packet_t(param1->retransmitted_oldest);
...
inline void assume_cp__picoquic_packet_context_t(picoquic_packet_context_t *src, picoquic_packet_context_t *dst)
{
  ...
  //assume(dst->retransmit_newest != NULL);
  //assume(dst->retransmit_newest != src->retransmit_newest);
...
{
  //sassert(param1 != param2); // not proved by opsem / proved by mono but perf issues
